...
export const DEFAULT_SCHOLARSHIPS = [
  ...
  { id: 'sc_umflint_transfer', name: 'UM Flint Transfer Scholarship', org: 'UM Flint', amount: 5000, deadline: 'Auto on admission', status: 'apply', priority: 'critical', url: 'https://www.umflint.edu/financialaid/', notes: '$2,500/yr × 2. Automatic at 3.0+. You have 3.7.' },
