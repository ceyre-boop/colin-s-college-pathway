...
export const DEFAULT_SCHOLARSHIPS = [
  { id: 'sc_pell', name: 'Pell Grant Renewal', org: 'Federal', amount: 7395, deadline: 'FAFSA Dec 2026', status: 'applied', appliedDate: '2026-07-07', priority: 'critical', url: 'https://studentaid.gov', notes: 'SAI -1500 = max eligibility. File FAFSA at studentaid.gov NOW.' },
  ...
  { id: 'sc_mi_competitive', name: 'Michigan Competitive Scholarship', org: 'Michigan OSFA', amount: 1000, deadline: 'FAFSA by Feb 2027', status: 'applied', priority: 'high', url: 'https://www.michigan.gov/mistudentaid', notes: 'Auto-considered when FAFSA filed.' },
