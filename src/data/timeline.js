...
export const INIT_TIMELINE = [
  ...
  { id: 23, year: 2030, month: 'Spring', title: 'BS Cellular & Molecular Biology', desc: 'University of Michigan-Flint. Optional CS / research support on top of the degree, not a second hidden degree. (Conservative target; could finish earlier if the plan compresses.)', cat: 'future', icon: '🎓', essay: '' },
