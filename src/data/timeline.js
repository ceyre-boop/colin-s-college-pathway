...
export const INIT_TIMELINE = [
  ...
  { id: 16, year: 2025, month: 'Aug', title: 'Started UM Flint — Molecular Biology', desc: 'Freshman year. CHM 260, BIO, Philosophy, Biopsychology.', cat: 'academic', icon: '🔬', essay: '' },
  ...
  { id: 22, year: 2028, month: 'Jan', title: 'Apply — Barry Goldwater Scholarship', desc: '$7,500/yr. The career-defining STEM scholarship. Need 1yr research + faculty nomination.', cat: 'future', icon: '🌟', essay: '' },
  { id: 23, year: 2029, month: 'May', title: 'BS Cellular & Molecular Biology + CS Minor', desc: 'University of Michigan. Published researcher. AI engineer. Quant trader.', cat: 'future', icon: '🎓', essay: '' },
  { id: 24, year: 2030, month: null, title: 'PhD / Industry — Computational Oncology', desc: 'Fully funded PhD or $150K+ at Tempus/Recursion. Building the AI that replaces the mouse cursor from the MRI room.', cat: 'future', icon: '🚀', essay: '' },
];
